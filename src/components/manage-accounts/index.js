      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <ul className="flex gap-8 p-0 my-[25px]">
          {accounts && accounts.length
            ? accounts.map((item) => (
                <li
                  className="max-w-[200px] min-w-[155px] w-[155px] cursor-pointer flex flex-col items-center gap-3"
                  key={item._id}
                  onClick={
                    showDeleteIcon
                      ? null
        ...
        <div className="text-center">
          <span
            ...
            className="border border-gray-100 cursor-pointer tracking-wide rounded-md inline-flex text-sm px-[1.5em] py-[0.5em]"
          >
            Manage Profiles
          </span>
        </div>
